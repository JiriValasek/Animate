...
## @brief Proxy class for a `DocumentObjectGroupPython` RobRotation instance.
#
...
class RobRotationProxy:
    ...
    #
    #
    # @param		fp	A `DocumentObjectGroupPython` RobRotation object to be extended.
    #
    ...
    ## @brief Method called after `DocumentObjectGroupPython` RobRotation was changed.
    #
    ...
    #
    #
    # @param		fp	A `DocumentObjectGroupPython` RobRotation object.
    ...
    #
    #
    # @param		fp	A restored `DocumentObjectGroupPython` RobRotation object.
    #
    ...
    #
    #
    # @param		fp	A restored or barebone `DocumentObjectGroupPython` RobRotation object.
    #
    ...
    ## @brief Method used to change a `RobRotation`'s joint variable sequence.
    #
    ...
    #
    #
    # @param		joint_sequence	A dictionary describing a rotation.
    #
    ...
    ## @brief Method to check that a property describes a rotation.
    #
    ...
    ## @brief Method to check if a rotation is valid.
    #
    ...
    # @param		thetas	A list of floats signifying rotation angles about Z axis.
    # @param		rotation	A dict containing all lists above.
    #
    # @return
...
## @brief Proxy class for `Gui.ViewProviderDocumentObject` RobRotation.ViewObject.
#
...
class ViewProviderRobRotationProxy:
    ...
    # standard methods---------------------------------------------------------
    ## @brief Initialization method for ViewProviderRobRotationProxy.
    #
    #A class instance is created and made a `Proxy` for a generic
    ...
    #
    #
    # @param		vp	A barebone `Gui.ViewProviderDocumentObject` RobRotation.ViewObject.
    #
    ...
    #
    #
    # @param		vp	A RobRotation.ViewObject after initialization.
    #
    ...
    #
    # @param		fp	A `DocumentObjectGroupPython` RobRotation object.
    # @param		prop	A str name of the changed property.
    #
    ...
    #
    #
    # @param		vp	A RobRotation.ViewObject.
    # @param		prop	A str name of a changed property.
    #
    ...
    #
    #
    # @param		obj	A FreeCAD object hovering above a RobRotation item in the Tree View.
    #
    ...
    #
    #
    # @param		vp	A `Gui.ViewProviderDocumentObject` RobRotation.ViewObject.
    #
    ...
    ## @brief Method called by FreeCAD when RobRotation is double-clicked in the Tree View.
    #
    ...
    ## @brief Method called by the FreeCAD to customize a RobRotation context menu.
    #
    ...
    #
    #
    # @param		vp	A rightclicked `Gui.ViewProviderDocumentObject` RobRotation.ViewObject.
    ...
    ## @brief Method which makes a Coin3D frame to show a current pose in a RobRotation.
    #
...
## @brief Class specifying Animate workbench's RobRotation button/command.
#
