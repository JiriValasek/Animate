...
## @brief Proxy class for a `DocumentObjectGroupPython` RobTranslation instance.
#
...
class RobTranslationProxy:
    ...
    ## @brief Initialization method for RobTranslationProxy.
    #
    ...
    #
    #
    # @param		fp	A `DocumentObjectGroupPython` RobTranslation object to be extended.
    #
    ...
    ## @brief Method called after `DocumentObjectGroupPython` RobTranslation was changed.
    #
    ...
    #
    #
    # @param		fp	A `DocumentObjectGroupPython` RobTranslation object.
    ...
    #
    #
    # @param		fp	A restored `DocumentObjectGroupPython` RobTranslation object.
    #
    ...
    #
    #
    # @param		fp	A restored or barebone RobTranslation object.
    #
    ...
    ## @brief Method used to change a `RobTranslation`'s joint variable sequence.
    #
    ...
    #
    # @param		fp	A `DocumentObjectGroupPython` RobTranslation object.
    # @param		joint_sequence	A dictionary describing a RobTranslation.
    #
    ...
    ## @brief Method to check that a property describes a translation.
    #
    ...
    ## @brief Method to check if a translation is valid.
    #
    ...
    # @param		ds	A list of floats signifying translation diplacements along Z axis.
    # @param		translation	A dict containing all lists above.
    #
    # @return
...
## @brief Proxy class for `Gui.ViewProviderDocumentObject` RobTranslation.ViewObject.
#
...
class ViewProviderRobTranslationProxy:
    ...
    # standard methods---------------------------------------------------------
    ## @brief Initialization method for ViewProviderRobTranslationProxy.
    #
    #A class instance is created and made a `Proxy` for a generic
    ...
    #
    #
    # @param		vp	A barebone `Gui.ViewProviderDocumentObject` RobTranslation.ViewObject.
    #
    ...
    #
    #
    # @param		vp	A RobTranslation.ViewObject after initialization.
    #
    ...
    ## @brief Method called after RobTranslation.ViewObject was changed.
    #
    #If visibility changed, an appropriate Coin3D construct hides the frame showing
    #current pose.
    #
    #
    # @param		vp	A RobTranslation.ViewObject.
    # @param		prop	A str name of a changed property.
    #
    ...
    #
    #
    # @param		obj	An object hovering above a RobTranslation item in the Tree View.
    #
    ...
    #
    #
    # @param		vp	A `Gui.ViewProviderDocumentObject` RobTranslation.ViewObject.
    #
    ...
    ## @brief Method called when RobTranslation is double-clicked in the Tree View.
    #
    ...
    ## @brief Method called by the FreeCAD to customize a RobTranslation context menu.
    #
    ...
    #
    #
    # @param		vp	A right-clicked RobTranslation.ViewObject.
    ...
    ## @brief Method which makes a Coin3D frame to show a current pose in a RobTranslation.
    #
...
## @brief Class specifying Animate workbench's RobTranslation button/command.
#
